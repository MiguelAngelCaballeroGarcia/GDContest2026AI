...
$input = "c:\Users\Asus\Desktop\GDContestAI2\data\Automatic-9.json"
...
$result = [PSCustomObject]@{
    benchmark = "lbvh-only-ab-automatic9-confidence"
    input = "data/Automatic-9.json"
...
$out = "c:\Users\Asus\Desktop\GDContestAI2\bench-ab\ab_benchmark_lbvh_automatic9_confidence.json"
